...
# CUDA_VISIBLE_DEVICES=3 python ovlabel_extraction.py
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Extract openset labels from generated reasons.")
    parser.add_argument(
        "--result-glob",
        default="output/results-mer2026ov/*/*.npz",
        help="Glob pattern used to locate reason npz files.",
    )
    ...
    for result_path in glob.glob(args.result_glob):
