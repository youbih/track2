...
class Human_Dataset(BaseDataset):
    def __init__(self, vis_processor=None, txt_processor=None, img_processor=None,
        ...
        if dataset_cfg is not None and dataset_cfg.get('label_csv', None) not in [None, ""]:
            ov_path = dataset_cfg.label_csv
        self.label_csv = ov_path
        name2openset = {}
        ...
        self.label_type_candidates = ['ovlabel']
        ##################################################################
